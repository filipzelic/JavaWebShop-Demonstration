				...
				<div class="top-row">
					<div class="col-xs-4">
						<div class="top-row-col1 text-center">
							...
							<h4>UKUPNO</h4>
							<label>357 PROIZVODA</label>
							<a class="r-list-w" href="products?category=woman"><img src="images/list-icon.png" title="list" /></a>
						</div>
					</div>
					<div class="col-xs-4">
						<div class="top-row-col1 text-center">
							...
							<h4>UKUPNO</h4>
							<label>357 PROIZVODA</label>
							<a class="r-list-w" href="products?category=man"><img src="images/list-icon.png" title="list" /></a>
						</div>
					</div>
					<div class="col-xs-4">
						<div class="top-row-col1 text-center">
							...
							<h4>UKUPNO</h4>
							<label>357 PROIZVODA</label>
							<a class="r-list-w" href="products?category=kids"><img src="images/list-icon.png" title="list" /></a>
						</div>
					</div>
				...
				<div class="special-products">
					<div class="s-products-head">
						<div class="s-products-head-left">
							<h3>IZDVOJENA <span>PONUDA</span></h3>
						</div>
						<div class="clearfix"> </div>
					</div>
